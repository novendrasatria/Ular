...
class game():
    def __init__(self,speed, size=1):
        ...
        pg.display.set_caption('Game Ulo Koros')
    ...
    def over(self):
        while 1:
            ...
            txts = pg.font.SysFont('Courier New',50).render('Emosi yaa? Score:',True,(255,255,255))
            ...
            self.screen.blit(txts,txtrect)
            pg.display.update()
            self.make_button((153,300,100,50),'Main neh', [(255,255,255),(150,150,150)], action = lambda:restart())
            if self.hover ==True:
...
class startmenu():
    def __init__(self):
        self.screen = pg.display.set_mode((800,450))
        self.b1 = '(150, 300,100,50),"Mulai", [(0,255,0), (0,150,0)], action = self.start'
        self.b2 = '(550, 300,100,50),"Metu", [(255,0,0), (150,0,0)], action = self.exit'
    ...
    def mainloop(self):
        while 1:
            self.screen.fill((35,38,117))
            self.make_text(400, 150, 'Game Ulo Koros', color = (255,255,255), size = 80, a = True)
            for event in pg.event.get():
                if event.type == pg.QUIT:
                    sys.exit()
            for x in self.blocks:
    ...
    def start(self):
        ...
        self.b2 = '(550, 300,100,50),"Gedhe", [(0,255,0), (0,150,0)], action = self.start4'
        self.buttons = [self.b1,self.b2]
    def start3(self):
        self.b1 = '(150, 300,100,50),"Gampang", [(0,255,0), (0,150,0)], action = self.e'
        self.b2 = '(283, 300,100,50),"Normal", [(0,255,0), (0,150,0)], self.n'
        self.b3 = '(417, 300,100,50),"Angel", [(0,255,0), (0,150,0)], action = self.h'
        self.b4 = '(550, 300,140,50),"Marai Emosi", [(0,255,0), (0,150,0)], action = self.ex'
